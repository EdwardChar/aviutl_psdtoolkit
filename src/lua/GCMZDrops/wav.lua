...
function P.ondragenter(files, state)
  for i, v in ipairs(files) do
    ...
    if ext == ".wav" or ext == ".txt" or ext == ".exo" then
      -- �ե�����Β����Ӥ� .wav �� .txt �� .exo �Υե����뤬���ä���I���Ǥ��뤫�⤷��ʤ��Τ� true
      return true
    end
  end
  return false
...
function P.parseexo(filepath)
  ...
  while 1 do
    ...
    if wav == nil and ((name == "��Ƶ�ļ�")or(name == "Audio file")) then
      wav = ini:get(i .. ".0", "file", nil)
      if j == nil or j == '' then
        j = ini:get(i .. ".0", "__json", nil)
      end
    elseif txt == nil and ((name == "�ı�")or(name == "Text")) then
...
function P.fire(files, state)
  ...
  -- setting.wav_firemode_wavtxt ���m�Ϥ��뤫�����å�
  ...
  -- setting.wav_firemode_exo ���m�Ϥ��뤫�����å�
...
function P.generateexo(wavfilepath, wavlen, subtitle, exabase, state, j)
  ...
  local modifiers = {
    ...
    ENCODE_LUA_STRING = function(v)
      v = GCMZDrops.convertencoding(v, "gbk", "utf8")
      v = GCMZDrops.encodeluastring(v)
      v = GCMZDrops.convertencoding(v, "utf8", "gbk")
      return v
    end,
  }
  ...
  f:close()
  debug_print("["..P.name.."] �ѱ��Ϸ��ļ��滻Ϊexo�ļ���")
